...
zones[xi.zone.ROMAEVE] =
{
    text =
    {
        ...
        PILE_OF_RUBBLE                = 7411,  -- It is nothing but a pile of rubble.
        A_CHILL_RUNS_DOWN_SPINE       = 7412,  -- A chill runs down your spine.
        SENSE_OMINOUS_PRESENCE        = 7415,  -- You sense an ominous presence...
        ITEMS_ITEMS_LA_LA             = 7418,  -- You can hear a strange voice... Items, items, la la la la la
        GOBLIN_SLIPPED_AWAY           = 7424,  -- The Goblin slipped away when you were not looking...
        PLAYER_OBTAINS_ITEM           = 7447,  -- <name> obtains <item>!
        UNABLE_TO_OBTAIN_ITEM         = 7448,  -- You were unable to obtain the item.
        PLAYER_OBTAINS_TEMP_ITEM      = 7449,  -- <name> obtains the temporary item: <item>!
        ALREADY_POSSESS_TEMP          = 7450,  -- You already possess that temporary item.
        NO_COMBINATION                = 7455,  -- You were unable to enter a combination.
        UNITY_WANTED_BATTLE_INTERACT  = 7517,  -- Those who have accepted % must pay # Unity accolades to participate. The content for this Wanted battle is #. [Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]
        REGIME_REGISTERED             = 9633,  -- New training regime registered!
