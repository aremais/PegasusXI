...
zones[xi.zone.MOUNT_ZHAYOLM] =
{
    text =
    {
        ...
        LARGE_KEYHOLE_HERE            = 7383, -- There is a large keyhole here. It seems to be a very simple mechanism.
        FITS_LARGE_KEYHOLE            = 7384, -- Obtained key item: %. You think it may fit the large keyhole.
        INSERT_INTO_KEYHOLE           = 7385, -- You insert the % into the keyhole.
