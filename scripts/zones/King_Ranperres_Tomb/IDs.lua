...
zones[xi.zone.KING_RANPERRES_TOMB] =
{
    text =
    {
        ...
        ITEMS_ITEMS_LA_LA             = 7375,  -- You can hear a strange voice... Items, items, la la la la la
        GOBLIN_SLIPPED_AWAY           = 7381,  -- The Goblin slipped away when you were not looking...
