...
entity.onMobSpellChoose = function(mob, target, spellId)
    ...
    local groupTable =
    {
        GetMobByID(mob:getID() - 4), -- Yo'Bhu Hideousmask
        GetMobByID(mob:getID() - 3), -- Zo'Dhu Legslicer
        GetMobByID(mob:getID() - 2), -- Ka'Nha Jabbertongue
        GetMobByID(mob:getID() - 1), -- Bi'Fho Jestergrin
        GetMobByID(mob:getID() + 1), -- Ea'Tho Cruelheart
    }
