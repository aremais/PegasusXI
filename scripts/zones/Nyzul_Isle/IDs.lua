...
zones[xi.zone.NYZUL_ISLE] =
{
    text =
    {
        ...
        TIME_REMAINING_MINUTES        = 7324, -- Time remaining: <number> [minute/minutes] (Earth time).
        TIME_REMAINING_SECONDS        = 7325, -- Time remaining: <number> [second/seconds] (Earth time).
        FADES_INTO_NOTHINGNESS        = 7326, -- The <keyitem> fades into nothingness...
        PARTY_FALLEN                  = 7327, -- All party members have fallen in battle. Mission failure in <number> [minute/minutes].
        ...
        OBJECTIVE_COMPLETE            = 7364, -- Floor <number> objective complete. Rune of Transfer activated.
        ...
        RESTRICTION_JOB_ABILITIES     = 7389, -- Job abilities are restricted.
        ...
        RESTRICTION_NINJUTSU          = 7395, -- Ninjutsu is restricted.
        RESTRICTION_SUMMON_MAGIC      = 7396, -- Summon magic is restricted.
        RESTRICTION_BLUE_MAGIC        = 7397, -- Blue magic is restricted.
        ...
        AFFLICTION_DEX_DOWN           = 7407, -- Afflicted by DEX Down.
        AFFLICTION_VIT_DOWN           = 7408, -- Afflicted by VIT Down.
        AFFLICTION_AGI_DOWN           = 7409, -- Afflicted by AGI Down.
        AFFLICTION_INT_DOWN           = 7410, -- Afflicted by INT Down.
        ...
        RECEIVED_FLURRY_EFFECT        = 7425, -- Received Flurry effect.
        ...
        RECEIVED_VIT_BOOST            = 7433, -- Received VIT Boost.
        RECEIVED_AGI_BOOST            = 7434, -- Received AGI Boost.
        RECEIVED_INT_BOOST            = 7435, -- Received INT Boost.
        RECEIVED_MND_BOOST            = 7436, -- Received MND Boost.
        ...
        NEW_USER                      = 7497, -- New user confirmed. Issuing <item>.
