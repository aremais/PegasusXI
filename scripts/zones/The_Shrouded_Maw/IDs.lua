...
zones[xi.zone.THE_SHROUDED_MAW] =
{
    text =
    {
        ...
        NO_BATTLEFIELD_ENTRY          = 7099, -- An unfathomable light is rising from this strangely marked platform...
        ...
        ASTRAL_DISINTEGRATES          = 7434, -- The <item> disintegrates before your eyes!
        CONQUEST_BASE                 = 7443, -- Tallying conquest results...
        ENTERING_THE_BATTLEFIELD_FOR  = 7606, -- Entering the battlefield for [Darkness Named/Test Your Mite/Waking Dreams/★Waking Dreams]!
    },
    mob =
    {
