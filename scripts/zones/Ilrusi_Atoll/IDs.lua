...
zones[xi.zone.ILRUSI_ATOLL] =
{
    text =
    {
        ...
        ASSAULT_41_START              = 7474, -- Commencing <assault>! Objective: Rescue the agent
        ASSAULT_42_START              = 7475, -- Commencing <assault>! Objective: Destroy the assassins
        ASSAULT_43_START              = 7476, -- Commencing <assault>! Objective: Defeat Sagelord Molaal Ja
        ASSAULT_44_START              = 7477, -- Commencing <assault>! Objective: Steal the supplies
        ASSAULT_45_START              = 7478, -- Commencing <assault>! Objective: Apprehend the spy
        ASSAULT_46_START              = 7479, -- Commencing <assault>! Objective: Recover the treasure
        ASSAULT_47_START              = 7480, -- Commencing <assault>! Objective: Annihilate the enemy
        ASSAULT_48_START              = 7481, -- Commencing <assault>! Objective: Neutralize the marids
        ASSAULT_49_START              = 7482, -- Commencing <assault>! Objective: Gather pathological data
        ASSAULT_50_START              = 7483, -- Commencing <assault>! Objective: Defeat Orochi
        ...
        CHEST                         = 7542, -- The chest contains...
        GOLDEN                        = 7543, -- ...a golden figurehead!
    },
    mob =
    {
        [1] =
