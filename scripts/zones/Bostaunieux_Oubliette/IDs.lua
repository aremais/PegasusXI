...
zones[xi.zone.BOSTAUNIEUX_OUBLIETTE] =
{
    text =
    {
        ...
        CHUMIA_DIALOG                 = 7329,  -- Welcome to Bostaunieux Oubliette...
        SEEMS_LOCKED                  = 7331,  -- It seems to be locked.
        SPIRAL_HELL_LEARNED           = 7438,  -- You have learned the weapon skill Spiral Hell!
        SENSE_OMINOUS_PRESENCE        = 7439,  -- You sense an ominous presence...
        ITEMS_ITEMS_LA_LA             = 7442,  -- You can hear a strange voice... Items, items, la la la la la
        GOBLIN_SLIPPED_AWAY           = 7448,  -- The Goblin slipped away when you were not looking...
        REGIME_REGISTERED             = 9553,  -- New training regime registered!
        PLAYER_OBTAINS_ITEM           = 10605, -- <name> obtains <item>!
        UNABLE_TO_OBTAIN_ITEM         = 10606, -- You were unable to obtain the item.
        PLAYER_OBTAINS_TEMP_ITEM      = 10607, -- <name> obtains the temporary item: <item>!
        ALREADY_POSSESS_TEMP          = 10608, -- You already possess that temporary item.
        NO_COMBINATION                = 10613, -- You were unable to enter a combination.
        LEARNS_SPELL                  = 10636, -- <name> learns <spell>!
        UNCANNY_SENSATION             = 10639, -- You are assaulted by an uncanny sensation.
        COMMON_SENSE_SURVIVAL         = 10646, -- It appears that you have arrived at a new survival guide provided by the Adventurers' Mutual Aid Network. Common sense dictates that you should now be able to teleport here from similar tomes throughout the world.
        UNITY_WANTED_BATTLE_INTERACT  = 10710, -- Those who have accepted % must pay # Unity accolades to participate. The content for this Wanted battle is #. [Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]
    },
    mob =
    {
