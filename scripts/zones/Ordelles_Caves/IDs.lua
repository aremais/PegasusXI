...
zones[xi.zone.ORDELLES_CAVES] =
{
    text =
    {
        ...
        RUILLONT_SANDORIA_DIALOG      = 7364,  -- Sandoria nation variant.
        RUILLONT_INITIAL_DIALOG       = 7366,  -- Confound it! If I only had my sword, I'd cut through these fiends single-handedly...
        RUILLONT_DEFAULT_DIALOG       = 7368,  -- Non-Sandoria nation variant.
        ...
        DRY_WIND                      = 7391,  -- It is dry here, probably because of the wind.
        CHEST_UNLOCKED                = 7413,  -- You unlock the chest!
        SENSE_A_FOUL_PRESENCE         = 7434,  -- You sense a foul presence.
        GERWITZS_AXE_DIALOG           = 7435,  -- Mine axe shall rend thy throat!
        GERWITZS_SWORD_DIALOG         = 7436,  -- Mine sword shall pierce thy tongue!
        GERWITZS_SOUL_DIALOG          = 7437,  -- Long have I waited. I will tell all...
        PLAYER_OBTAINS_ITEM           = 8398,  -- <name> obtains <item>!
        UNABLE_TO_OBTAIN_ITEM         = 8399,  -- You were unable to obtain the item.
        PLAYER_OBTAINS_TEMP_ITEM      = 8400,  -- <name> obtains the temporary item: <item>!
        ALREADY_POSSESS_TEMP          = 8401,  -- You already possess that temporary item.
        NO_COMBINATION                = 8406,  -- You were unable to enter a combination.
        REGIME_REGISTERED             = 10484, -- New training regime registered!
