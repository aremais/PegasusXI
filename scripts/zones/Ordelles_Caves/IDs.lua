...
zones[xi.zone.ORDELLES_CAVES] =
{
    text =
    {
        ...
        RUILLONT_SANDORIA_DIALOG      = 7366,  -- Sandoria nation variant (+2 from initial on retail layout).
        RUILLONT_DEFAULT_DIALOG       = 7370,  -- Non-Sandoria nation variant (+1 from 7369 on client).
        ...
        GERWITZS_AXE_DIALOG           = 7434,  -- Mine axe shall rend thy throat!
        GERWITZS_SWORD_DIALOG         = 7435,  -- Mine sword shall pierce thy tongue!
        GERWITZS_SOUL_DIALOG          = 7436,  -- Long have I waited. I will tell all...
        PLAYER_OBTAINS_ITEM           = 8397,  -- <name> obtains <item>!
        UNABLE_TO_OBTAIN_ITEM         = 8398,  -- You were unable to obtain the item.
        PLAYER_OBTAINS_TEMP_ITEM      = 8399,  -- <name> obtains the temporary item: <item>!
        ALREADY_POSSESS_TEMP          = 8400,  -- You already possess that temporary item.
        NO_COMBINATION                = 8405,  -- You were unable to enter a combination.
        REGIME_REGISTERED             = 10483, -- New training regime registered!
        COMMON_SENSE_SURVIVAL         = 11559, -- It appears that you have arrived at a new survival guide provided by the Adventurers' Mutual Aid Network. Common sense dictates that you should now be able to teleport here from similar tomes throughout the world.
    },
    mob =
    {
