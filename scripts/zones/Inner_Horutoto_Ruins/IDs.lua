...
zones[xi.zone.INNER_HORUTOTO_RUINS] =
{
    text =
    {
        ...
        NOT_BROKEN_ORB                = 7254,  -- The Mana Orb in this receptacle is not broken.
        EXAMINED_RECEPTACLE           = 7255,  -- You have already examined this receptacle.
        DOOR_FIRMLY_CLOSED            = 7282,  -- The door is firmly closed.
        CAT_BURGLARS_HIDEOUT          = 7284,  -- It looks like that Cat Burglar's hideout lies behind this door! You were able to confirm <keyitem>!
        ...
        COMMON_SENSE_SURVIVAL         = 10555, -- It appears that you have arrived at a new survival guide provided by the Adventurers' Mutual Aid Network. Common sense dictates that you should now be able to teleport here from similar tomes throughout the world.
    },
    mob =
    {
