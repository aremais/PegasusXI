...
zones[xi.zone.GARLAIGE_CITADEL] =
{
    text =
    {
        ...
        BOXES_SCATTERED               = 7357,  -- Boxes are carelessly scattered here. Perhaps you could open them with %.
        FEELS_WRONG                   = 7361,  -- Something feels wrong, but nothing happens.
        ITEMS_ITEMS_LA_LA             = 7474,  -- You can hear a strange voice... Items, items, la la la la la
        GOBLIN_SLIPPED_AWAY           = 7480,  -- The Goblin slipped away when you were not looking...
        YOU_COULD_OPEN_THE_GATE       = 7532,  -- If only you had %, you could open the banishing gate...
        THE_GATE_OPENS_FOR_YOU        = 7533,  -- By the power of your %, the gate opens for you.
        COMBINE_INTO_A_CHUNK          = 7535,  -- You combine the % you have collected into a single chunk.
        ...
        REGIME_REGISTERED             = 9626,  -- New training regime registered!
        LEARNS_SPELL                  = 11544, -- <name> learns <spell>!
        UNCANNY_SENSATION             = 11546, -- You are assaulted by an uncanny sensation.
        COMMON_SENSE_SURVIVAL         = 11577, -- It appears that you have arrived at a new survival guide provided by the Adventurers' Mutual Aid Network. Common sense dictates that you should now be able to teleport here from similar tomes throughout the world.
        UNITY_WANTED_BATTLE_INTERACT  = 11641, -- Those who have accepted % must pay # Unity accolades to participate. The content for this Wanted battle is #. [Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]
    },
    mob =
    {
