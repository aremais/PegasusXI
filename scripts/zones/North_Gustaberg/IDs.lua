...
zones[xi.zone.NORTH_GUSTABERG] =
{
    text =
    {
        ...
        SENSE_EVIL_PRESENCE           = 7354,  -- You sense an evil presence...
        SPARKLING_LIGHT               = 7395,  -- The ground is sparkling with a strange light.
        SHINING_OBJECT_SLIPS_AWAY     = 7459,  -- The shining object slips through your fingers and is washed further down the stream.
        REACH_WATER_FROM_HERE         = 7466,  -- You can reach the water from here.
        CONQUEST                      = 7502,  -- You've earned conquest points!
        ITEMS_ITEMS_LA_LA             = 7854,  -- You can hear a strange voice... Items, items, la la la la la
        GOBLIN_SLIPPED_AWAY           = 7860,  -- The Goblin slipped away when you were not looking...
        GARRISON_BASE                 = 7870,  -- Hm? What is this? %? How do I know this is not some [San d'Orian/Bastokan/Windurstian] trick?
        PLAYER_OBTAINS_ITEM           = 8085,  -- <name> obtains <item>!
        UNABLE_TO_OBTAIN_ITEM         = 8086,  -- You were unable to obtain the item.
        PLAYER_OBTAINS_TEMP_ITEM      = 8087,  -- <name> obtains the temporary item: <item>!
        ALREADY_POSSESS_TEMP          = 8088,  -- You already possess that temporary item.
        NO_COMBINATION                = 8093,  -- You were unable to enter a combination.
        VOIDWALKER_DESPAWN            = 8124,  -- The monster fades before your eyes, a look of disappointment on its face.
        TIME_ELAPSED                  = 8200,  -- Time elapsed: <number> [hour/hours] (Vana'diel time) <number> [minute/minutes] and <number> [second/seconds] (Earth time)
