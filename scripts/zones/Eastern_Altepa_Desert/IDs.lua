...
zones[xi.zone.EASTERN_ALTEPA_DESERT] =
{
    text =
    {
        ...
        ALREADY_OBTAINED_TELE         = 7680,  -- You already possess the gate crystal for this telepoint.
        REMNANTS_OF_A_PAST_AGE        = 7684,  -- These are remnants of a past age, made from a rare kind of stone.
        FEEL_A_HOSTILE_GAZE           = 7685,  -- You feel a hostile gaze upon you!
        GARRISON_BASE                 = 7707,  -- Hm? What is this? %? How do I know this is not some [San d'Orian/Bastokan/Windurstian] trick?
        PLAYER_OBTAINS_ITEM           = 7780,  -- <name> obtains <item>!
        UNABLE_TO_OBTAIN_ITEM         = 7781,  -- You were unable to obtain the item.
        PLAYER_OBTAINS_TEMP_ITEM      = 7782,  -- <name> obtains the temporary item: <item>!
        ALREADY_POSSESS_TEMP          = 7783,  -- You already possess that temporary item.
        NO_COMBINATION                = 7788,  -- You were unable to enter a combination.
        UNITY_WANTED_BATTLE_INTERACT  = 7850,  -- Those who have accepted % must pay # Unity accolades to participate. The content for this Wanted battle is #. [Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]
        REGIME_REGISTERED             = 9966,  -- New training regime registered!
        COMMON_SENSE_SURVIVAL         = 11102, -- It appears that you have arrived at a new survival guide provided by the Adventurers' Mutual Aid Network. Common sense dictates that you should now be able to teleport here from similar tomes throughout the world.
    },
    mob =
    {
