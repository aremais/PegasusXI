...
zones[xi.zone.BIBIKI_BAY] =
{
    text =
    {
        ...
        CLUNK_CLUNK_WHIRL_WHIZZ       = 7390, -- <Clunk-clunk>... <Whirl-whizz>...!
        IT_WAS_A_TRAP                 = 7459, -- It was a trap!
        YOU_ARE_NOT_ALONE             = 7460, -- You are not alone!
        NO_BILLET                     = 7502, -- You were refused passage for failing to present <item>!
        HAVE_BILLET                   = 7507, -- You cannot buy morrre than one <item>. Use the one you have now to ride the next ship.
        LEFT_BILLET                   = 7512, -- You use your <item>. (<number> trip[/s] remaining)
        END_BILLET                    = 7513, -- You use up your <item>.
        NOTHING_LEFT_INTEREST         = 7630, -- There is nothing left of interest here.
        SHEN_QM                       = 7631, -- Innumerable shrimp shells are floating in the water here.
        SHEN_SPAWN                    = 7632, -- The <item> begins skimming quietly across the surface of the water. ...What's this!? An enormous creature is chasing after it from below!!!
        UNITY_WANTED_BATTLE_INTERACT  = 8636, -- Those who have accepted % must pay # Unity accolades to participate. The content for this Wanted battle is #. [Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]
        ...
        NEWS_BILLET                   = 8681, -- <item> has been [added to your list of favorites/removed from your list of favorites].
    },
    mob =
    {
