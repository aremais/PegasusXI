    ...
    npc =
    {
        QM =
        {
            [16945639] =
            {
                ...
                trade =
                {
                    { item = 3458,                       mob = 16945153 }, -- Antaeus (Undying Juju)
                    { item = { 3479, 3480, 3481, 3482 }, mob = 16945403 }, -- Arch Antaeus (Fiendish Tome II ch.10–13)
                },
            },
            [16945640] = { trade = { { item = 3468, mob = 16945421 } } }, -- Lost Stringes (vial of nightmare blood)
            [16945641] = { trade = { { item = 3467, mob = 16945457 } } }, -- Lost Scolopendra (nightmare shell)
            [16945642] = { trade = { { item = 3469, mob = 16945470 } } }, -- Lost Suttung (nightmare shard)
        },
    },
}
