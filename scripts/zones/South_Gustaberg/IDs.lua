...
zones[xi.zone.SOUTH_GUSTABERG] =
{
    text =
    {
        ...
        MONSTER_TRACKS                = 7421, -- You see monster tracks on the ground.
        MONSTER_TRACKS_FRESH          = 7422, -- You see fresh monster tracks on the ground.
        FIRE_GOOD                     = 7425, -- The fire seems to be good enough for cooking.
        FIRE_PUT                      = 7426, -- You put <item> in the fire.
        FIRE_TAKE                     = 7427, -- You take <item> out of the fire.
        FIRE_LONGER                   = 7428, -- It may take a little while more to cook the <item>.
        MEAT_ALREADY_PUT              = 7429, -- The <item> is already in the fire.
        ITEMS_ITEMS_LA_LA             = 7528, -- You can hear a strange voice... Items, items, la la la la la
        GOBLIN_SLIPPED_AWAY           = 7534, -- The Goblin slipped away when you were not looking...
        PLAYER_OBTAINS_ITEM           = 7548, -- <name> obtains <item>!
        UNABLE_TO_OBTAIN_ITEM         = 7549, -- You were unable to obtain the item.
        PLAYER_OBTAINS_TEMP_ITEM      = 7550, -- <name> obtains the temporary item: <item>!
        ALREADY_POSSESS_TEMP          = 7551, -- You already possess that temporary item.
        NO_COMBINATION                = 7556, -- You were unable to enter a combination.
        UNITY_WANTED_BATTLE_INTERACT  = 7618, -- Those who have accepted % must pay # Unity accolades to participate. The content for this Wanted battle is #. [Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]
        ...
        REGIME_REGISTERED             = 9918, -- New training regime registered!
    },
    mob =
    {
