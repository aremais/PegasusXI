...
zones[xi.zone.OUTER_HORUTOTO_RUINS] =
{
    text =
    {
        ...
        COMMENCING_EXPERIMENT         = 7363,  -- CoMM-eN-cInG★Ex-PE-rI-MeNt.
        INITIATING_TRANSMISSION       = 7364,  -- Da-TA★cO-LLeC-TiOn★COmP-LETe! INi-TiAT-iNG★TRAnS-miSS-IOn★TO★PRo-FeSS-oR...
