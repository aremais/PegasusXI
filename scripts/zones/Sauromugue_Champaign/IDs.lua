...
zones[xi.zone.SAUROMUGUE_CHAMPAIGN] =
{
    text =
    {
        ...
        TIME_ELAPSED                  = 7669,  -- Time elapsed: <number> [hour/hours] (Vana'diel time) <number> [minute/minutes] and <number> [second/seconds] (Earth time)
        REGIME_REGISTERED             = 9826,  -- New training regime registered!
        VOIDWALKER_NO_MOB             = 10999, -- The <keyitem> quivers ever so slightly, but emits no light. There seem to be no monsters in the area.
        ...
        VOIDWALKER_OBTAIN_KI          = 11007, -- Obtained key item: <keyitem>!
        LEARNS_SPELL                  = 12507, -- <name> learns <spell>!
        UNCANNY_SENSATION             = 12509, -- You are assaulted by an uncanny sensation.
