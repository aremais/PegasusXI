...
zones[xi.zone.BALGAS_DAIS] =
{
    text =
    {
        ...
        WILD_WILD_WHISKERS_OFFSET     = 7676, -- Macan Gadangan's whiskers begin to twitch slightly.
        SOUL_GEM_REACTS               = 7681, -- The <keyitem> reacts to the <keyitem>, sending a jolt of energy through your veins!
        PROMISE_ME_YOU_WONT_GO_DOWN   = 7696, -- Promise you won't go down too easy, okay?
        IM_JUST_GETTING_WARMED_UP     = 7697, -- Haha! I'm just getting warmed up!
        YOU_PACKED_MORE_OF_A_PUNCH    = 7698, -- Hah! You pack more of a punch than I thoughtaru. But I won't go down as easy as old Maat!
        WHATS_THIS_STRANGE_FEELING    = 7699, -- What's this strange feeling...? It's not supposed to end...like...
        HUH_IS_THAT_ALL               = 7700, -- Huh? Is that all? I haven't even broken a sweataru...
        YIKEY_WIKEYS                  = 7701, -- Yikey-wikeys! Get that thing away from meee!
        WHATS_THE_MATTARU             = 7702, -- <Pant, wheeze>... What's the mattaru, <name>? Too much of a pansy-wansy to fight fair?
    },
    mob =
    {
