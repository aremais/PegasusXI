...
zones[xi.zone.VALKURM_DUNES] =
{
    text =
    {
        ...
        AN_EMPTY_LIGHT_SWIRLS          = 7789,  -- An empty light swirls about the cave, eating away at the surroundings...
        GARRISON_BASE                  = 7771,  -- Hm? What is this? %? How do I know this is not some [San d'Orian/Bastokan/Windurstian] trick?
        TIME_ELAPSED                   = 7218,  -- Time elapsed: <number> [hour/hours] (Vana'diel time) <number> [minute/minutes] and <number> [second/seconds] (Earth time)
