...
zones[xi.zone.RIVERNE_SITE_B01] =
{
    text =
    {
        ...
        ENTERING_THE_BATTLEFIELD_FOR  = 7605, -- Entering the battlefield for [Storms of Fate/The Wyrmking Descends]!
        SD_VERY_SMALL                 = 7607, -- The spatial displacement is very small. If you only had some item that could make it bigger...
        SD_HAS_GROWN                  = 7608, -- The spatial displacement has grown.
        SPACE_SEEMS_DISTORTED         = 7609, -- The space around you seems oddly distorted and disrupted.
        MONUMENT                      = 7615, -- Something has been engraved on this stone, but the message is too difficult to make out.
        GROUND_GIVING_HEAT            = 7617, -- The ground here is giving off heat.
        BAHAMUT_TAUNT                 = 7685, -- Children of Vana'diel, what do you think to accomplish by fighting for your lives? You know your efforts are futile, yet still you resist...
