...
zones[xi.zone.LUFAISE_MEADOWS] =
{
    text =
    {
        ...
        KI_STOLEN                     = 7701, -- The <keyitem> has been stolen!
        ...
        LOGGING_IS_POSSIBLE_HERE      = 7749, -- Logging is possible here if you have <item>.
        SURVEY_THE_SURROUNDINGS       = 7756, -- You survey the surroundings but see nothing out of the ordinary.
        MURDEROUS_PRESENCE            = 7757, -- Wait, you sense a murderous presence...!
        YOU_CAN_SEE_FOR_MALMS         = 7758, -- You can see for malms in every direction.
        SPINE_CHILLING_PRESENCE       = 7760, -- You sense a spine-chilling presence!
        AMALTHEIA_TEXT                = 7799, -- A message has been engraved into the rock: Offer up the ancient shield, and the pact shall be honored.
        KURREA_TEXT                   = 7803, -- The stench of rotten flesh fills the air around you. Some scavenger must have made this place its territory.
        KURREA_SLURP                  = 7805, -- Kurrea slurps down the adamantoise soup!
        KURREA_MUSCLES                = 7807, -- Kurrea's muscles bulge crazily!
        KURREA_SHINE                  = 7808, -- Kurrea's scales shine mysteriously!
        KURREA_WIND                   = 7809, -- Kurrea is enveloped by a fierce wind!
        KURREA_RIGID                  = 7810, -- Kurrea's hide grows rigid!
        KURREA_VEIN                   = 7811, -- The veins in Kurrea's head are popping out!
        KURREA_EYES                   = 7812, -- Kurrea's eyes glow weirdly!
        KURREA_CURE                   = 7813, -- Kurrea's wounds disappear!
        KURREA_AURA                   = 7814, -- Kurrea is surrounded by an ominous aura!
        KURREA_GREEN                  = 7815, -- Kurrea's face has turned green...
        COMMON_SENSE_SURVIVAL         = 8755, -- It appears that you have arrived at a new survival guide provided by the Adventurers' Mutual Aid Network. Common sense dictates that you should now be able to teleport here from similar tomes throughout the world.
        UNITY_WANTED_BATTLE_INTERACT  = 8819, -- Those who have accepted % must pay # Unity accolades to participate. The content for this Wanted battle is #. [Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]
    },
    mob =
    {
