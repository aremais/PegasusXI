...
-- No events: grant pack directly on trade to avoid interaction/event loop.
-----------------------------------
...
local function grantStarterPack(player)
    ...
    player:addItem(xi.item.KINGDOM_AKETON)
    player:addItem(xi.item.KINGDOM_SIGNET_STAFF)
