...
zones[xi.zone.XARCABARD] =
{
    text =
    {
        ...
        REGION_POINTS_SANDORIA         = 7147,  -- San d'Oria's region points have increased!
        EXP_FORCE_KILL_SANDORIA        = 7150,  -- San d'Orian E.F. defeats beastmen hordes... Maintain current momentum.
        BEASTMEN_BANNER_CURSE          = 7161,  -- There was a curse on the beastmen's banner!
        BEASTMEN_BANNER_LIFTED         = 7162,  -- The curse of the beastmen's banner has been lifted!
