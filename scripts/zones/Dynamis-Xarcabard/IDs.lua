...
zones[xi.zone.DYNAMIS_XARCABARD] =
{
    text =
    {
        ...
        ANIMATED_KNUCKLES_DIALOG      = 7218, -- I am known as the Fists of Mystics. Come, show me your fighting spirit.
        ANIMATED_DAGGER_DIALOG        = 7350, -- I am called the Ornate Blade. Now, show me your strength.
        ANIMATED_LONGSWORD_DIALOG     = 7352, -- People have named me the Holy Blade. I will try thy resolution.
        ANIMATED_CLAYMORE_DIALOG      = 7414, -- I am the Intricate Blade. Show me the depths of your fury!
        ANIMATED_TABAR_DIALOG         = 7556, -- Me, axe. Runaeic, Axe. You, die?
        ...
        PRISON_OF_SOULS_HAS_SET_FREE  = 7830, -- The prison of souls has set free its captive spirits!
    },
    mob =
    {
        TIME_EXTENSION =
