...
zones[xi.zone.BUBURIMU_PENINSULA] =
{
    text =
    {
        ...
        REGION_POINTS_SANDORIA         = 7169,  -- San d'Oria's region points have increased!
        EXP_FORCE_KILL_SANDORIA        = 7172,  -- San d'Orian E.F. defeats beastmen hordes... Maintain current momentum.
        BEASTMEN_BANNER_CURSE          = 7183,  -- There was a curse on the beastmen's banner!
        BEASTMEN_BANNER_LIFTED         = 7184,  -- The curse of the beastmen's banner has been lifted!
