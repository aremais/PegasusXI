...
zones[xi.zone.BHAFLAU_THICKETS] =
{
    text =
    {
        ...
        WARHORSE_HOOFPRINT_SET        = 6402, -- You set the <keyitem> in the warhorse hoofprint.
        ...
        STAGING_GATE_MAMOOL           = 7329, -- Mamool Ja Staging Point.
        ...
        HAND_OVER_TO_IMMORTAL         = 7559, -- You hand over the % to the Immortal.
        YOUR_IMPERIAL_STANDING        = 7560, -- Your Imperial Standing has increased!
        HARVESTING_IS_POSSIBLE_HERE   = 7578, -- Harvesting is possible here if you have <item>.
        CANNOT_ENTER                  = 7601, -- You cannot enter at this time. Please wait a while before trying again.
        AREA_FULL                     = 7602, -- This area is fully occupied. You were unable to enter.
        MEMBER_NO_REQS                = 7606, -- Not all of your party members meet the requirements for this objective. Unable to enter area.
        MEMBER_TOO_FAR                = 7610, -- One or more party members are too far away from the entrance. Unable to enter area.
        WELLSPRING                    = 7670, -- The water in this spring is an unusual color...
        SHED_LEAVES                   = 7679, -- The ground is strewn with shed leaves...
        BLOOD_STAINS                  = 7681, -- The ground is smeared with bloodstains...
        DRAWS_NEAR                    = 7706, -- Something draws near!
        HOMEPOINT_SET                 = 7717, -- Home point set!
    },
    mob =
    {
        CHIGOES              =
