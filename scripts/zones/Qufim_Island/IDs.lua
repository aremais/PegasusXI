...
zones[xi.zone.QUFIM_ISLAND] =
{
    text =
    {
        ...
        LOGIN_NUMBER                   = 7005,  -- In celebration of your most recent login (login no. <number>), we have provided you with <number> points! You currently have a total of <number> points.
        ...
        THESE_WITHERED_FLOWERS         = 7349,  -- These withered flowers seem unable to bloom.
        NOW_THAT_NIGHT_HAS_FALLEN      = 7350,  -- Now that night has fallen, the flowers bloom with a strange glow.
        CONQUEST                       = 7398,  -- You've earned conquest points!
        AN_EMPTY_LIGHT_SWIRLS          = 7757,  -- An empty light swirls about the cave, eating away at the surroundings...
        GARRISON_BASE                  = 7762,  -- Hm? What is this? %? How do I know this is not some [San d'Orian/Bastokan/Windurstian] trick?
        GIGANTIC_FOOTPRINT             = 7841,  -- There is a gigantic footprint here.
        ASA_SNOW                       = 7854,  -- You see the following words scrawled into the snow: Shantotto Empire Provisional Headquarters.
        ...
        DYNA_NPC_DEFAULT_MESSAGE       = 7991,  -- There is a strange symbol drawn here. A haunting chill sweeps through you as you gaze upon it...
        ...
        NO_COMBINATION                 = 7073,  -- You were unable to enter a combination.
        UNITY_WANTED_BATTLE_INTERACT   = 8135,  -- Those who have accepted % must pay # Unity accolades to participate. The content for this Wanted battle is #. [Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]
        REGIME_REGISTERED              = 10349, -- New training regime registered!
        LEARNS_SPELL                   = 12667, -- <name> learns <spell>!
        UNCANNY_SENSATION              = 12669, -- You are assaulted by an uncanny sensation.
        COMMON_SENSE_SURVIVAL          = 12676, -- It appears that you have arrived at a new survival guide provided by the Adventurers' Mutual Aid Network. Common sense dictates that you should now be able to teleport here from similar tomes throughout the world.
        HOMEPOINT_SET                  = 12718, -- Home point set!
    },
    mob =
    {
