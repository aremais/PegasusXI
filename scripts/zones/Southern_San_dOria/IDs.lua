...
zones[xi.zone.SOUTHERN_SAN_DORIA] =
{
    text =
    {
        ...
        YOU_HAVE_JOINED_UNITY          = 16005, -- You have joined [Pieuje's/Ayame's/Invincible Shield's/Apururu's/Maat's/Aldo's/Jakoh Wahcondalo's/Naja Salaheem's/Flaviria's/Yoran-Oran's/Sylvie's] Unity!
