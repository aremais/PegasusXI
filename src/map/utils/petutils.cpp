...
void CalculateAvatarStats(CBattleEntity* PMaster, CPetEntity* PPet)
{
    ...
    {
        int16 fenrirAttBonus = static_cast<int16>(std::floor(2 * battleutils::GetMaxSkill(xi::SkillType::Club, xi::Job::WHM, mLvl > 99 ? 99 : mLvl) * 0.30f));
        PPet->addModifier(xi::Mod::ATT, fenrirAttBonus);
    }
