...
INSERT INTO `mob_groups` (
    ...
    (16, 1394, 28, 'Fomors_Bats', 0, 128, 0, 0, 0, 49, 51, 0, NULL),
    (10, 1394, 51, 'Fomors_Bats', 0, 128, 0, 0, 0, 58, 60, 0, NULL),
    (9, 1394, 52, 'Fomors_Bats', 0, 128, 0, 0, 0, 58, 60, 0, NULL),
    (10, 71, 29, 'Air_Elemental', 330, 4, 38, 0, 0, 57, 64, 0, NULL),
    (22, 4507, 29, 'Ziryu', 0, 128, 0, 0, 0, 75, 75, 0, NULL)
...
INSERT INTO `mob_groups` (
    ...
    (1, 2717, 122, 'Mokkurkalfi', 0, 128, 0, 0, 0, 68, 70, 0, NULL)
ON DUPLICATE KEY UPDATE
    `poolid` = VALUES(`poolid`),
    `name` = VALUES(`name`),
    `respawntime` = VALUES(`respawntime`),
